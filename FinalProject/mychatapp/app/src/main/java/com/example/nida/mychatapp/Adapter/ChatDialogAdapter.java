package com.example.nida.mychatapp.Adapter;
...
import com.example.nida.mychatapp.ChatDialoguActivity;
import com.example.nida.mychatapp.R;
import com.quickblox.chat.model.QBChatDialog;
import java.util.ArrayList;
/*
 * Created by nida on 3/25/18.
...
public class ChatDialogAdapter extends BaseAdapter
{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(view == null)
        {
            ...
            txtMessage=(TextView)view.findViewById(R.id.list_chat_message);

            txtTitle=(TextView)view.findViewById(R.id.list_chat_title);
            ...
            //first character from chat title
